...
from Routers.AddComing.ComingRouter.amount_router import amountRouter
from Routers.AddComing.ComingRouter.category_router import categoryRouter
from Routers.AddComing.ComingRouter.comment_router import commentRouter
from Routers.AddComing.ComingRouter.date_router import dateRouter
...
async def delete_coming_adding(message: Message, state: FSMContext) -> None:
