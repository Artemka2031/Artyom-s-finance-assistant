...
async def rename_category_action(query: CallbackQuery, callback_data: RenameCategoryCallback, state: FSMContext):
    ...
    await state.set_state(RenameCategory.new_category_name)


@renameCategoryRouter.callback_query(RenameCategory.new_category_name,
...
@renameCategoryRouter.message(RenameCategory.new_category_name, flags={"limit_category_len": True})
